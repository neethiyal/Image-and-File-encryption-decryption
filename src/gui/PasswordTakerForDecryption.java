...
public class PasswordTakerForDecryption extends javax.swing.JFrame
{
   private File[] listOfFilesAndFolders;
    public PasswordTakerForDecryption(File[] listOfFilesAndFolders) throws InstantiationException, UnsupportedLookAndFeelException
    {
        ...
        } catch (ClassNotFoundException ex)
        {
           ...
           Logger.getLogger(PasswordTakerForDecryption.class.getName()).log(Level.SEVERE, null, ex);
       }
        //</editor-fold>
        initComponents();
        setResizable(false);
