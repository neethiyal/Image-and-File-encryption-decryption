...
class ImageWinD extends JFrame implements ActionListener{

	/** Image Display panel */
	private ImageReadD panel;

	/** Image encrypter class */
	private ImageEncryptD encrypter;
